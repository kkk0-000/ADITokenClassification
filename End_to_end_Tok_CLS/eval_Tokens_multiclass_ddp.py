"""
Multi-class token classification evaluation with multi-GPU support via Accelerate.

Launch examples:
  # Multi-GPU:
  accelerate launch --num_processes 4 eval_Tokens_multiclass_ddp.py --num_classes 3 ...
  # Single GPU:
  python eval_Tokens_multiclass_ddp.py --num_classes 3 ...
"""
...
from train_Tokens_multiclass_ddp import MyDataset
...
def get_parameters():
    parser = argparse.ArgumentParser(description='Multi-class token eval (DDP)')
