"""
Multi-class token prediction with multi-GPU support via Accelerate.

Launch examples:
  # Multi-GPU:
  accelerate launch --num_processes 4 pred_Token_multiclass_ddp.py -i input.csv ...
  # Single GPU:
  python pred_Token_multiclass_ddp.py -i input.csv ...
"""
...
def get_parameters():
    parser = argparse.ArgumentParser(description='Multi-class token prediction (DDP)')
